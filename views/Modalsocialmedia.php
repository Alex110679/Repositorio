        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="social_media_form">
                ...
                <div class="modal-footer">
                    <button type="submit" name="action" value="add" class="btn btn-outline-primary tx-11 tx-uppercase pd-y-12 pd-x-2"></button>
                    <button type="reset" class="btn btn-outline-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"></button>
                </div>
            </form>
        </div>
    </div>
