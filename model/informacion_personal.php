...
class Informacion_personal extends Conectar{
    ...
    /*public function get_informacion_personal_con_parametros($idinformacion_personal){
        $social=parent::conexion();
        parent::set_names();
    ...
    public function insert_informacion_personal($info_nacimiento,$info_celular,$info_email,$info_url,$info_direccion,$info_cargo){
        $social=parent::conexion();
        parent::set_names();
        $sql="INSERT INTO informacion_personal (idinformacion_personal,info_nacimiento,info_celular,info_email,info_url,info_direccion,info_cargo) VALUES(NULL,?,?,?,?,?,?,1)";
        $sql=$social->prepare($sql);
